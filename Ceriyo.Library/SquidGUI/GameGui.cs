...
namespace Ceriyo.Library.SquidGUI
{
    ...
    public class Inventory : UIWindow
    {
        ...
        void button_MouseDrag(Control sender, MouseEventArgs args)
        {
            ...
            image.Position = GuiHost.MousePosition;
            image.Tag = slot.Item;
    ...
    public class MiniMap : Window
    {
        ...
        {
            sender.Position += GuiHost.MouseMovement;
        }
        ...
        void handle_OnMousePress(Control sender, MouseEventArgs args)
        {
            ...
            ResizeTo(oldSize + (clickedPos - GuiHost.MousePosition), AnchorStyles.Top | AnchorStyles.Left);
        }
    ...
    public class ChatWindow : Window
    {
        ...
        void handle_OnMousePress(Control sender, MouseEventArgs args)
        {
            ...
            p.y = clickedPos.y - GuiHost.MousePosition.y;
        ...
        void AddPage(string name)
        {
            ...
            page.Button.Update += delegate(Control sender)
            {
                ...
                close.Visible = page.Button.Checked || page.Button.Hit(GuiHost.MousePosition.x, GuiHost.MousePosition.y);
            };
