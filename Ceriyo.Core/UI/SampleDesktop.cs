...
namespace Ceriyo.Core.UI
{
    public class SampleDesktop : Desktop
    {
        public SampleDesktop()
        {
            ...
            skin.Cursors.Add(Cursors.Default, new Cursor { Texture = "Graphics\\Cursors\\Arrow.png", Size = cursorSize, HotSpot = Point.Zero });
            skin.Cursors.Add(Cursors.Link, new Cursor { Texture = "Graphics\\Cursors\\Link.png", Size = cursorSize, HotSpot = Point.Zero });
            skin.Cursors.Add(Cursors.Move, new Cursor { Texture = "Graphics\\Cursors\\Move.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.Select, new Cursor { Texture = "Graphics\\Cursors\\Select.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.SizeNS, new Cursor { Texture = "Graphics\\Cursors\\SizeNS.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.SizeWE, new Cursor { Texture = "Graphics\\Cursors\\SizeWE.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.HSplit, new Cursor { Texture = "Graphics\\Cursors\\SizeNS.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.VSplit, new Cursor { Texture = "Graphics\\Cursors\\SizeWE.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.SizeNESW, new Cursor { Texture = "Graphics\\Cursors\\SizeNESW.png", Size = cursorSize, HotSpot = halfSize });
            skin.Cursors.Add(Cursors.SizeNWSE, new Cursor { Texture = "Graphics\\Cursors\\SizeNWSE.png", Size = cursorSize, HotSpot = halfSize });
