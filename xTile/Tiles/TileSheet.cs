...
namespace xTile.Tiles
{
    ...
    public class TileSheet : DescribedComponent
    {
        ...
        /// <summary>
        /// Reference to a GameResource containing the tile image. May be a disk path, URL,
        /// content pipeline reference etc. - subject to display
        /// device implementation in use
        /// </summary>
        public GameResource ImageSource
        {
        ...
        /// <param name="resource">Reference to a Ceriyo GameResource</param>
        /// <param name="sheetSize">Size of the sheet in tiles</param>
        /// <param name="tileSize">Size of the tiles in pixels</param>
        public TileSheet(Map map, GameResource resource, Size sheetSize, Size tileSize)
        {
            m_map = map;
            m_imageSource = resource;
        ...
        {
            m_map = map;
            m_imageSource = new GameResource(string.Empty, resource, ResourceType.Graphic, ResourceSubType.Tileset);
            m_sheetSize = sheetSize;
            m_tileSize = tileSize;
            m_margin = m_spacing = Size.Zero;
            m_tileIndexPropertyAccessor = new TileIndexPropertyAccessor(this);
        ...
        /// <param name="sheetSize">Size of the sheet in tiles</param>
        /// <param name="tileSize">Size of the tiles in pixels</param>
        public TileSheet(string id, Map map, GameResource resource, Size sheetSize, Size tileSize)
            : base(id)
        {
            m_map = map;
            m_imageSource = resource;
        ...
        private Map m_map;
        private GameResource m_imageSource;
